...
export const eventAssets = {
  ...
  leadership: {
    ...
    mechFacultyCoordinator: "/media/innohack26-dr-m-vijay-anand-mech-faculty-coordinator.jpg",
    ...
    eieHod: "/media/innohack26-eie-hod.jpg",
