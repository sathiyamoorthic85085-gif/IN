...
export const eventKnowledgeBase: EventKnowledgeChunk[] = [
  ...
  { id: "registration", title: "Registration and squads", keywords: ["registration", "register", "fee", "cost", "500", "member", "squad", "team"], text: "Registration is ₹500 per participant. Every squad must have two to four named members, and all registration fields are required." },
